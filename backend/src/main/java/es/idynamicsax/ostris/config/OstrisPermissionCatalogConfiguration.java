...
public class OstrisPermissionCatalogConfiguration {
    @Bean
    ModulePermissionCatalogDescriptor ostrisPermissionCatalogDescriptor() {
        return new ModulePermissionCatalogDescriptor("ostris");
    }
}
